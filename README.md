...
# test codecov darwin py39-test

![test codecov darwin py39-test banner](docs/_static/banner.svg)
<div align="center">
    <p>
        <em>
            A Python package.
    ...
    <p>
        ...
        <a href="https://github.com/whiteprints-tests/test-codecov-darwin-py39-test/discussions"><img alt="GitHub Discussions" src="https://img.shields.io/github/discussions/whiteprints-tests/test-codecov-darwin-py39-test.svg?logo=GitHub"></a>
        <a href="https://api.reuse.software/info/github.com/whiteprints-tests/test-codecov-darwin-py39-test"><img alt="REUSE status" src="https://api.reuse.software/badge/github.com/whiteprints-tests/test-codecov-darwin-py39-test"/></a>
